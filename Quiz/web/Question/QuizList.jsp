                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                <thead>
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0">Quiz id</th>
                                    <th class="sorting" tabindex="0" >Total Attempts</th>
                                    <th class="sorting" tabindex="0" ># of Correct Answers</th>
                                </thead>
                                <tbody>
                        ...
                        <!-- /.box-body -->
                        <div>
                            <a class="btn btn-primary" href="/question?page=Quiz">Take New Quiz</a>
                        </div>
                    </div>
                    <!-- /.box -->
                </div>
